...
tenengineering <- salary_2022 %>%
  as.data.frame() %>%
  clean_names() %>%
  filter(division == "A. James Clark School of Engineering", category_status_cd == "01") %>%
  mutate(appt_base_annual_salary = as.numeric(appt_base_annual_salary)) %>%
  summarise(
    appt_base_annual_salary = median(appt_base_annual_salary, na.rm=TRUE)
  )
...
tencmns <- salary_2022 %>%
  as.data.frame() %>%
  clean_names() %>%
  filter(division == "College of Computer, Math & Natural Sciences", category_status_cd == "01") %>%
  mutate(appt_base_annual_salary = as.numeric(appt_base_annual_salary)) %>%
  summarise(
    appt_base_annual_salary = median(appt_base_annual_salary, na.rm=TRUE)
  )
...
tenpres <- salary_2022 %>%
  as.data.frame() %>%
  clean_names() %>%
  filter(division == "Office of the President", category_status_cd == "01") %>%
  mutate(appt_base_annual_salary = as.numeric(appt_base_annual_salary)) %>%
  summarise(
    appt_base_annual_salary = median(appt_base_annual_salary, na.rm=TRUE)
  )
...
tenagr <- salary_2022 %>%
  as.data.frame() %>%
  clean_names() %>%
  filter(division == "College of Agriculture & Natural Resources", category_status_cd == "01") %>%
  mutate(appt_base_annual_salary = as.numeric(appt_base_annual_salary)) %>%
  summarise(
    appt_base_annual_salary = median(appt_base_annual_salary, na.rm=TRUE)
  )
...
tenarhu <- salary_2022 %>%
  as.data.frame() %>%
  clean_names() %>%
  filter(division == "College of Arts & Humanities", category_status_cd == "01") %>%
  mutate(appt_base_annual_salary = as.numeric(appt_base_annual_salary)) %>%
  summarise(
    appt_base_annual_salary = median(appt_base_annual_salary, na.rm=TRUE)
  )
...
tenbsos <- salary_2022 %>%
  as.data.frame() %>%
  clean_names() %>%
  filter(division == "College of Behavioral & Social Sciences", category_status_cd == "01") %>%
  mutate(appt_base_annual_salary = as.numeric(appt_base_annual_salary)) %>%
  summarise(
    appt_base_annual_salary = median(appt_base_annual_salary, na.rm=TRUE)
  )

teneducation <- salary_2022 %>%
  as.data.frame() %>%
  clean_names() %>%
  filter(division == "College of Education", category_status_cd == "01") %>%
  mutate(appt_base_annual_salary = as.numeric(appt_base_annual_salary)) %>%
  summarise(
    appt_base_annual_salary = median(appt_base_annual_salary, na.rm=TRUE)
  )

teninfosci <- salary_2022 %>%
  as.data.frame() %>%
  clean_names() %>%
  filter(division == "College of Information Studies", category_status_cd == "01") %>%
  mutate(appt_base_annual_salary = as.numeric(appt_base_annual_salary)) %>%
  summarise(
    appt_base_annual_salary = median(appt_base_annual_salary, na.rm=TRUE)
  )
...
tenjour <- salary_2022 %>%
  as.data.frame() %>%
  clean_names() %>%
  filter(division == "Philip Merrill College of Journalism", category_status_cd == "01") %>%
  mutate(appt_base_annual_salary = as.numeric(appt_base_annual_salary)) %>%
  summarise(
    appt_base_annual_salary = median(appt_base_annual_salary, na.rm=TRUE)
  )

tenbusiness <- salary_2022 %>%
  as.data.frame() %>%
  clean_names() %>%
  filter(division == "Robert H. Smith School of Business", category_status_cd == "01") %>%
  mutate(appt_base_annual_salary = as.numeric(appt_base_annual_salary)) %>%
  summarise(
    appt_base_annual_salary = median(appt_base_annual_salary, na.rm=TRUE)
  )

tenarchitecture <- salary_2022 %>%
  as.data.frame() %>%
  clean_names() %>%
  filter(division == "School of Architecture, Planning, & Preservation", category_status_cd == "01") %>%
  mutate(appt_base_annual_salary = as.numeric(appt_base_annual_salary)) %>%
  summarise(
    appt_base_annual_salary = median(appt_base_annual_salary, na.rm=TRUE)
  )
...
tensph <- salary_2022 %>%
  as.data.frame() %>%
  clean_names() %>%
  filter(division == "School of Public Health", category_status_cd == "01") %>%
  mutate(appt_base_annual_salary = as.numeric(appt_base_annual_salary)) %>%
  summarise(
    appt_base_annual_salary = median(appt_base_annual_salary, na.rm=TRUE)
  )

tenpolicy <- salary_2022 %>%
  as.data.frame() %>%
  clean_names() %>%
  filter(division == "School of Public Policy", category_status_cd == "01") %>%
  mutate(appt_base_annual_salary = as.numeric(appt_base_annual_salary)) %>%
  summarise(
    appt_base_annual_salary = median(appt_base_annual_salary, na.rm=TRUE)
  )
