...
journalism <- data %>%
  clean_names() %>%
  filter(grepl("Philip Merrill College of Journalism", division)) %>%
  filter(grepl("Tenured Faculty|Tenure Track Faculty", category_status)) %>%
  count()
